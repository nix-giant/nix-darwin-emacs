...
I want to constrain only the output of config, not the form in which it is provided.

But, what should I do if I want to use .org file as config? Convert =.org= file to =.el= file before using it. For example:
#+begin_src nix
