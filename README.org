...
- remove the support of using org files in =config= option.
- remove =alwaysTangle= option.
...
{ pkgs, ... }:
{
  environment.systemPackages = [
    (pkgs.emacsWithPackagesFromUsePackage {
      ...
      #
      # To bundle the config into the final result, set defaultInitFile to true.
